...
contains
    ...
    subroutine initialize(a, b, s, N, r1, r2)
        ...
        do i = 1, 4000
            call calc_r(a, b, s, N, r1, r2)
        end do

    end subroutine

    subroutine montecarlo(a, b, s, N, k, r1, r2, Eav, var)
    ...
    subroutine calc_x(a, b, s, N, r1, r2)
        ...
        real(8), dimension(:, :), intent(inout) :: r1
        real(8), dimension(:, :), intent(inout) :: r2
        real(8), dimension(3, N) :: delta_r1
        real(8), dimension(3, N) :: delta_r2
        real(8), dimension(2, N) :: p
        real(8), dimension(2, N) :: u
        real(8), dimension(2, N) :: tf 

        call random_number(delta_r1)
        delta_r1 = 1d0 * (delta_r1(:, :) - 0.5d0)
        p = min(psi(a, x + delta_r1) / psi(a, r1) , 1d0)
