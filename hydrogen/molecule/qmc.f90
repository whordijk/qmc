...
contains
    ...
    subroutine metropolis(s, beta, a, r)
        ...
        real(8), intent(in) :: a
        real(8), dimension(:, :), intent(inout) :: r
        real(8), dimension(3, size(r, dim = 2)) :: delta_r
        real(8), dimension(1, size(r, dim = 2)) :: p
        real(8), dimension(1, size(r, dim = 2)) :: u
        real(8), dimension(1, size(r, dim = 2)) :: tf 
        integer :: i
    ...
    subroutine calc_E_L(s, beta, a, r, E_L)
        ...
        real(8), dimension(1, size(r, dim = 2)) :: gam

        real(8), dimension(3, size(r, dim = 2)) :: r1L
        real(8), dimension(3, size(r, dim = 2)) :: r1R
        real(8), dimension(3, size(r, dim = 2)) :: r2L
        real(8), dimension(3, size(r, dim = 2)) :: r2R
        real(8), dimension(3, size(r, dim = 2)) :: r12
        
        real(8), dimension(1, size(r, dim = 2)) :: r1Lsq
        real(8), dimension(1, size(r, dim = 2)) :: r1Rsq
        real(8), dimension(1, size(r, dim = 2)) :: r2Lsq
        real(8), dimension(1, size(r, dim = 2)) :: r2Rsq
        real(8), dimension(1, size(r, dim = 2)) :: r12sq
    ...
    function psi(s, beta, a, r)
        ...
        real(8), dimension(1, size(r, dim = 2)) :: r1L
        real(8), dimension(1, size(r, dim = 2)) :: r1R
        real(8), dimension(1, size(r, dim = 2)) :: r2L
        real(8), dimension(1, size(r, dim = 2)) :: r2R
        real(8), dimension(1, size(r, dim = 2)) :: r12
